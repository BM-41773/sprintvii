  ...
  //  var a = parseInt(serchedname1);
   ...
   // alert(image);
    $.ajax({
        ...
        dataType: 'Json',
        url: 'Home/pst',
        data: { X_loginid: serchedname1, postingimage: image, Status: status1 },
        success: function (data) {
            //   var a=0;
            // for (var x = 0; x < data.length; x++) {
            //  if (data[x].relation == 0) {
            console.log("ID: " + data[0].logginId + " name: " + data[0].NFFirstname + " picture: " + data[0].NFProfilepic + "posting:" + data[0].NFstatus + "pstimage:" + data[0].imageposting + "pstcontent:" + headerposting);
