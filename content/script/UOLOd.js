  ...
  //  alert("aaauyuyyyy");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var html = '<img src="' + data[0].NFProfilepic + '" style="height:35px; "/> <label style="margin-left:5px;">' + data[0].NFFirstname + '</label> <br><label>' + data[0].headerposting + ' <img src="' + data[0].imgposting + '" style="height:40px;" /><input type="text" id="poststatus"/><br/><hr>'
            $(".nws").append(html);
            $(".nws").show();
